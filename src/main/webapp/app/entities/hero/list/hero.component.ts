...
export class HeroComponent implements OnInit {
  ...
  trackId(_index: number, item: IHero): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IHero[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
